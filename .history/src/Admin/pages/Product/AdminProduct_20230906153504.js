    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter"> {productName} Image </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <OwlCarousel className="owl-theme Image-caro" items={1}  loop margin={10} nav>
            {images?.map((i, index) => (
              <img src={i} key={index} />
            ))}
          </OwlCarousel>
